...
<head>
    <meta charset="utf-8" />
    <title>TechTutor Pro | Ubah password</title>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <form method="POST" action="{{ route('password.update') }}" class="form-horizontal">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Masukan email" name="email" value="{{ $email ?? old('email') }}">
